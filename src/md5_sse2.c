...
hash_stat MD5_SSE(unsigned char* pPlain[SSE_SIMULTANEOUS], int nPlainLen[SSE_SIMULTANEOUS], unsigned char* pHash[SSE_SIMULTANEOUS])
{
...
hash_stat MD5_SSE_SHORT(unsigned char* pPlain[SSE_SIMULTANEOUS], int nPlainLen[SSE_SIMULTANEOUS], unsigned char* pHash[SSE_SIMULTANEOUS])
{
    __m128i mOne = _mm_set1_epi32(0xFFFFFFFF);
    __m128i mCa = _mm_set1_epi32(Ca);
    __m128i mCb = _mm_set1_epi32(Cb);
...
hash_stat MD5_SSE_FIXED(unsigned char* pPlain[SSE_SIMULTANEOUS], int nPlainLen, unsigned char* pHash[SSE_SIMULTANEOUS])
{
...
hash_stat MD5_SSE_SHORT_FIXED(unsigned char * __restrict pPlain[SSE_SIMULTANEOUS], int nPlainLen, unsigned char* pHash[SSE_SIMULTANEOUS])
{
    __m128i mOne = _mm_set1_epi32(0xFFFFFFFF);
    __m128i w0_1, w0_2, w0_3, w1_1, w1_2, w1_3, w2_1, w2_2, w2_3, w3_1, w3_2, w3_3, w14_1, w14_2, w14_3;
    __m128i a;
	...
	*(pPlain[i+3]+nPlainLen)=0x80;
    ...
    w14_1 = _mm_set_epi32(np,np,np,np);
    w14_2 = _mm_set_epi32(np,np,np,np);
    w14_3 = _mm_set_epi32(np,np,np,np);
