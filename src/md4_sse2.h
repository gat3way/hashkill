...
tmp1_2 = (b2) & (c2);\
tmp1_3 = (b3) & (c3);\
tmp1 = tmp1 | _mm_andnot_si128((b),(d));\
tmp1_2 = tmp1_2 | _mm_andnot_si128((b2),(d2));\
tmp1_3 = tmp1_3 | _mm_andnot_si128((b3),(d3));\
...
(a) = _mm_or_si128(tmp1,(_mm_srli_epi32(a, 32-s))); \
(a2) = _mm_or_si128(tmp1_2,(_mm_srli_epi32(a2, 32-s))); \
(a3) = _mm_or_si128(tmp1_3,(_mm_srli_epi32(a3, 32-s))); \
} 
