...
#define MD5STEP_ROUND1(a, b, c, d, AC, x, s)  (a)=(a)+bitselect((d),(c),(b))+(AC)+(x);(a) = rotate(a,s)+(b);
#define MD5STEP_ROUND1_NOC(a, b, c, d, AC, x, s)  (a)=(a)+bitselect((d),(c),(b))+(x);(a) = rotate(a,s)+(b);
#define MD5STEP_ROUND1_NULL(a, b, c, d, AC, s)  (a)=(a)+bitselect((d),(c),(b))+(AC);(a) = rotate(a,s)+(b);
...
#define MD5STEP_ROUND2(a, b, c, d, AC, x, s)  (a)=(a)+bitselect((c),(b),(d))+(AC)+(x);(a) = rotate(a,s)+(b);
#define MD5STEP_ROUND2_NULL(a, b, c, d, AC, s)  (a)=(a)+bitselect((c),(b),(d))+(AC); (a) = rotate(a,s)+(b);
#define MD5STEP_ROUND2S(a, b, c, d, AC, x, s)  (a)=(a)+bitselect((c),(b),(d))+(x);(a) = rotate(a,s)+(b);
...
void md5_long1( __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains, __global uint *bitmaps, __global uint *found,  uint4 singlehash, uint factor,uint8 x0, uint8 x1, uint8 x2, uint8 SIZE, uint8 c0, uint8 c1,uint8 c2, uint8 d0, uint8 d1, uint8 d2, uint8 t1, uint8 t2, uint8 t3,uint8 t4) 
{  

uint8 a=(uint8)0x67452301;
...
#define MD5STEP_ROUND1_NOC(a, b, c, d, AC, x, s)  (a)=(a)+(x)+bitselect((d),(c),(b));(a) = rotate(a,s)+(b);
...
#define MD5STEP_ROUND2(a, b, c, d, AC, x, s)  (a)=(a)+(AC)+(x)+bitselect((c),(b),(d));(a) = rotate(a,s)+(b);
#define MD5STEP_ROUND2S(a, b, c, d, AC, x, s)  (a)=(a)+(x)+bitselect((c),(b),(d));(a) = rotate(a,s)+(b);
...
a=a+(uint8)0x67452301;b=b+(uint8)0xefcdab89;c=c+(uint8)0x98badcfe;d=d+(uint8)0x10325476;
...
plains[res*8] = (uint4)(x0.s0,x1.s0-mAC2,x2.s0-mAC3,0);
plains[res*8+1] = (uint4)(x0.s1,x1.s1-mAC2,x2.s1-mAC3,0);
plains[res*8+2] = (uint4)(x0.s2,x1.s2-mAC2,x2.s2-mAC3,0);
plains[res*8+3] = (uint4)(x0.s3,x1.s3-mAC2,x2.s3-mAC3,0);
plains[res*8+4] = (uint4)(x0.s4,x1.s4-mAC2,x2.s4-mAC3,0);
plains[res*8+5] = (uint4)(x0.s5,x1.s5-mAC2,x2.s5-mAC3,0);
plains[res*8+6] = (uint4)(x0.s6,x1.s6-mAC2,x2.s6-mAC3,0);
plains[res*8+7] = (uint4)(x0.s7,x1.s7-mAC2,x2.s7-mAC3,0);
}



void md5_long2( __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains, __global uint *bitmaps, __global uint *found,  uint4 singlehash, uint factor,uint8 x0, uint8 x1, uint8 x2, uint8 x3, uint8 SIZE, uint8 c0, uint8 c1,uint8 c2, uint8 d0, uint8 d1, uint8 d2, uint8 t1, uint8 t2, uint8 t3,uint8 t4) 
{  
...
plains[res*8] = (uint4)(x0.s0,x1.s0-mAC2,x2.s0-mAC3,x3.s0);
plains[res*8+1] = (uint4)(x0.s1,x1.s1-mAC2,x2.s1-mAC3,x3.s1);
plains[res*8+2] = (uint4)(x0.s2,x1.s2-mAC2,x2.s2-mAC3,x3.s2);
plains[res*8+3] = (uint4)(x0.s3,x1.s3-mAC2,x2.s3-mAC3,x3.s3);
plains[res*8+4] = (uint4)(x0.s4,x1.s4-mAC2,x2.s4-mAC3,x3.s4);
plains[res*8+5] = (uint4)(x0.s5,x1.s5-mAC2,x2.s5-mAC3,x3.s5);
plains[res*8+6] = (uint4)(x0.s6,x1.s6-mAC2,x2.s6-mAC3,x3.s6);
plains[res*8+7] = (uint4)(x0.s7,x1.s7-mAC2,x2.s7-mAC3,x3.s7);
}
...
x0=(i|j);
c0=x0+(uint8)0xe9b6c7aa;
d0=x0+(uint8)0xeaa127fa;
c2=SIZE+(uint8)0xc33707d6-(uint8)0xa679438e;
d2=SIZE+(uint8)0xfde5380c-(uint8)0xa679438e;


input=(uint4)(chbase1.s0,chbase1.s1,chbase1.s2,chbase1.s3);
singlehash=(uint4)(chbase2.s0,chbase2.s1,chbase2.s2,chbase2.s3);
x1 = (uint8)input.y; 
c1=x1+(uint8)0xf61e2562-(uint8)0xe8c7b756;
t4=(uint8)(singlehash.z^singlehash.w);
d1=x1+(uint8)0xa4beea44-(uint8)0xe8c7b756; 
t1=(uint8)(singlehash.x)-x0; 
t2=(uint8)(singlehash.y)-(t4^t1);
...
#define MD5STEP_ROUND1_NOC(a, b, c, d, AC, x, s)  tmp1 = (c)^(d);tmp1 = tmp1 & (b);tmp1 = tmp1 ^ (d);(a) = (a)+(tmp1); (a) = (a)+(x);(a) = rotate(a,s);(a) = (a)+(b);  
