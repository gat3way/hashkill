...
ipb2_short( __global uint4 *dst, uint16 input, uint size,  uint8 chbase,  __global uint *found_ind, uint16 salt, __global uint *found, __global  uint *table,  uint4 singlehash) 
{
...
#define MD5STEP_ROUND1_NOC(a, b, c, d, AC, x, s)  (a)=(a)+(x)+bitselect((b),(c),(d));(a) = ROTATE(a,s)+(b);
...
#define MD5STEP_ROUND2(a, b, c, d, AC, x, s)  (a)=(a)+(AC)+(x)+bitselect((d),(b),(c));(a) = ROTATE(a,s)+(b);
#define MD5STEP_ROUND2S(a, b, c, d, AC, x, s)  (a)=(a)+(x)+bitselect((d),(b),(c));(a) = ROTATE(a,s)+(b);
...
a = (uint4)mCa; b = (uint4)mCb; c = (uint4)mCc; d = (uint4)mCd;
id=0;
...
x0 = ((uint4)(i)); 
x1 = (chbase1)|(uint4)input.s1;
x2 = (uint4)input.s2;
x3 = (uint4)input.s3;
x4 = (uint4)input.s4;
x5=x6=x7=x8=x9=x10=x11=x12=x13=(uint4)0;
x15=(uint4)0;
x14=SIZE;
...
a = (uint)mCa; b = (uint)mCb; c = (uint)mCc; d = (uint)mCd;
id=0;
...
x0 = ((uint)(i)); 
x1 = (chbase1)|(uint)input.s1;
x2 = (uint)input.s2;
x3 = (uint)input.s3;
x4 = (uint)input.s4;
x5=x6=x7=x8=x9=x10=x11=x12=x13=(uint)0;
x15=(uint)0;
x14=SIZE;
...
b3 +=  (b3>57) ? 39 : 0; 
b4 +=  (b4>57) ? 39 : 0; 
w8=(uint)( b2|(b1<<8)|(b4<<16)|(b3<<24) ,b6|(b5<<8)|(b8<<16)|(b7<<24), b10|(b9<<8)|(b12<<16)|(b11<<24), b14|(b13<<8)|(b16<<16)|(b15<<24) );
