...
sha1_passsalt_long( __global uint4 *dst,const uint4 input,const uint size, const uint8 chbase, __global uint *found_ind, uint16 salt, __global uint *found, __global uint *table, const uint4 singlehash) 
{
...
__kernel void  __attribute__((reqd_work_group_size(128, 1, 1))) 
sha1_passsalt_long( __global uint *dst,const uint4 input,const uint size, const uint8 chbase, __global uint *found_ind, uint16 salt, __global uint *found, __global uint *table, const uint4 singlehash) 
{
