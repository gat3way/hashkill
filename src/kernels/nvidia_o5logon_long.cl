...
void o5logon_long1(__local uint lTe[256],__local uint lTd[256],__local uint lTdK[256], __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains,  __global uint *found,  uint4 singlehash, uint k, uint16 salt, uint16 aessalt) 
{  
...
o5logon_long_double( __global uint4 *hashes,  const uint size,  __global uint4 *plains, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4,uint16 chbase5,uint16 chbase6) 
{
uint i;
uint j,k;
uint c0,x0;
...
o5logon_long1(lTe,lTd,lTdK,hashes,input, size, plains, found, singlehash,k,chbase3,chbase5);


input=(uint4)(chbase1.s4,chbase1.s5,chbase1.s6,chbase1.s7);
singlehash=(uint4)(chbase2.s4,chbase2.s5,chbase2.s6,chbase2.s7);
o5logon_long1(lTe,lTd,lTdK,hashes,input, size, plains,  found, singlehash,k,chbase4,chbase6);
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
o5logon_long_normal( __global uint4 *hashes,  const uint size,  __global uint4 *plains, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4,uint16 chbase5,uint16 chbase6) 
{
uint i;
uint j,k;
uint c0,x0;
