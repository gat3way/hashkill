...
lm_short( __global uint4 *dst, uint4 input, uint size, uint4 chbase,  __global uint *found_ind, __global uint *bitmaps, __global uint *found, __global const uint *table,  uint4 singlehash) 
{
...
chbase1=(uint2)(chbase.s2,chbase.s3);
chbase1>>=8;
chbase1+=(uint2)(chbase.s0,chbase.s1);
...
if (size==1) {w0=chbase1|(ib<<8)|(ic<<16)|(id<<24);w1=ie;}
else if (size==2) {w0|=(chbase1<<8)|(ib<<16)|(ic<<24);w1=(id)|(ie<<8);}  
else if (size==3) {w0|=(chbase1<<16)|(ib<<24);w1=ic|(id<<8)|(ie<<16);}
else if (size==4) {w0|=(chbase1<<24);w1=(ib)|(ic<<8)|(id<<16)|(ie<<24);}  
else if (size==5) {w1=chbase1|(ib<<8)|(ic<<16)|(id<<24);w2=(ie);} 
else if (size==6) {w1|=(chbase1<<8)|(ib<<16)|(ic<<24);w2=(id)|(ie<<8);}  
else if (size==7) {w1|=(chbase1<<16)|(ib<<24);w2=(ic)|(id<<8)|(ie<<16);} 
else if (size==8) {w1|=(chbase1<<24);w2=(ib)|(ic<<8)|(id<<16)|(ie<<24);}  
else if (size==9) {w2=(chbase1)|(ib<<8)|(ic<<16)|(id<<24);w3=(ie);}
else if (size==10) {w2|=(chbase1<<8)|(ib<<16)|(ic<<24);w3=(id)|(ie<<8);} 
else if (size==11) {w2|=(chbase1<<16)|(ib<<24);w3=(ic)|(id<<8)|(ie<<16);}
...
dst[(getglobalid(0)*2)] = (uint4)(blo11.x,blo12.x,o11.x,o12.x);
dst[(getglobalid(0)*2)+1] = (uint4)(blo11.y,blo12.y,o11.y,o12.y);
