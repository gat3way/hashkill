...
{
    x0 |= (ib<<16)|(ic<<24);
    x1 |= id|(ie<<8)|(chbase<<16);
}
else if (size==4)
{
    x0 |= (ib<<24);
    x1 |= ic|(id<<8)|(ie<<16)|(chbase<<24);
}
else if (size==5)
{
...
{
    x1 |= (ib<<16)|(ic<<24);
    x2 |= id|(ie<<8)|(chbase<<16);
}
else if (size==8)
{
    x1 |= (ib<<24);
    x2 |= ic|(id<<8)|(ie<<16)|(chbase<<24);
}
else if (size==9)
{
...
if (all((uint8)singlehash.x !=a+mCa)) return;
