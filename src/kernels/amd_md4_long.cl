...
void md4_long1( __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains, __global uint *bitmaps, __global uint *found,  uint4 singlehash,uint4 x0)
{  
...
plains[res*4] = (uint4)(w0.s0,w1.s0,w2.s0,w3.s0);
plains[res*4+1] = (uint4)(w0.s1,w1.s1,w2.s1,w3.s1);
plains[res*4+2] = (uint4)(w0.s2,w1.s2,w2.s2,w3.s2);
plains[res*4+3] = (uint4)(w0.s3,w1.s3,w2.s3,w3.s3);
}
