...
void md5md5_long1( __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains, __global uint *bitmaps, __global uint *found,  uint4 singlehash, uint x0) 
{  
...
md5md5STEP_ROUND3_EVEN(H, a, b, c, d, mAC33, x5, S31);  
md5md5STEP_ROUND3_ODD(H, d, a, b, c, mAC34, x8, S32);  
md5md5STEP_ROUND3_NULL_EVEN (H, c, d, a, b, mAC35, S33);
md5md5STEP_ROUND3_ODD (H, b, c, d, a, mAC36, SIZE, S34);
md5md5STEP_ROUND3_EVEN (H, a, b, c, d, mAC37, x1, S31); 
md5md5STEP_ROUND3_ODD (H, d, a, b, c, mAC38,x4, S32);  
md5md5STEP_ROUND3_EVEN (H, c, d, a, b, mAC39,x7, S33);  
md5md5STEP_ROUND3_NULL_ODD (H, b, c, d, a, mAC40, S34);
md5md5STEP_ROUND3_NULL_EVEN (H, a, b, c, d, mAC41, S31); 
md5md5STEP_ROUND3_ODD (H, d, a, b, c, mAC42, x0, S32); 
md5md5STEP_ROUND3_EVEN (H, c, d, a, b, mAC43, x3, S33); 
md5md5STEP_ROUND3_ODD (H, b, c, d, a, mAC44,x6, S34);  
md5md5STEP_ROUND3_NULL_EVEN (H, a, b, c, d, mAC45, S31);
md5md5STEP_ROUND3_NULL_ODD (H, d, a, b, c, mAC46, S32); 
md5md5STEP_ROUND3_NULL_EVEN (H, c, d, a, b, mAC47, S33); 
md5md5STEP_ROUND3_ODD (H, b, c, d, a, mAC48, x2, S34); 
...
md5md5_long_double( __global uint4 *hashes,  const uint size,  __global uint4 *plains, __global uint *bitmaps, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4) 
{
uint i;
uint j,k;
uint c0,x0;
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
md5md5_long_normal( __global uint4 *hashes,  const uint size,  __global uint4 *plains, __global uint *bitmaps, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4) 
{
uint i;
uint j,k;
uint c0,x0;
