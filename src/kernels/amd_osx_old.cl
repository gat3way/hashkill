...
__kernel void __attribute__((reqd_work_group_size(64, 1, 1))) 
osx_old( __global uint4 *dst,  __global uint *input, __global uint *size,  __global uint *found_ind, __global uint *found,  uint4 singlehash, uint16 salt) 
{
...
w0=(uint4)salt.s0;
w1.s0=input[id*4*8];
w2.s0=input[id*4*8+1];
w3.s0=input[id*4*8+2];
w4.s0=input[id*4*8+3];
w5.s0=input[id*4*8+4];
w6.s0=input[id*4*8+5];
w7.s0=input[id*4*8+6];
w8.s0=input[id*4*8+7];
w1.s1=input[id*4*8+8];
w2.s1=input[id*4*8+9];
w3.s1=input[id*4*8+10];
w4.s1=input[id*4*8+11];
w5.s1=input[id*4*8+12];
w6.s1=input[id*4*8+13];
w7.s1=input[id*4*8+14];
w8.s1=input[id*4*8+15];
w1.s2=input[id*4*8+16];
w2.s2=input[id*4*8+17];
w3.s2=input[id*4*8+18];
w4.s2=input[id*4*8+19];
w5.s2=input[id*4*8+20];
w6.s2=input[id*4*8+21];
w7.s2=input[id*4*8+22];
w8.s2=input[id*4*8+23];
w1.s3=input[id*4*8+24];
w2.s3=input[id*4*8+25];
w3.s3=input[id*4*8+26];
w4.s3=input[id*4*8+27];
w5.s3=input[id*4*8+28];
w6.s3=input[id*4*8+29];
w7.s3=input[id*4*8+30];
w8.s3=input[id*4*8+31];
w9=w10=w11=w12=w13=w14=w16=(uint4)0;
