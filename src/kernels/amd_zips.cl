...
uint2 TTA,TTB,TTC,TTD,TTE,TTF,TTTA,TTTB,TTTC;
...
w3=(uint2)salt.s8;
SIZE=(uint2)salt.s9;
w4=w5=w6=w7=w8=w9=w10=w11=w12=w13=w14=(uint2)0;
...
if (all((uint2)(salt.sF&0xFFFF)!=((TTD)&0xFFFF))) return;

found[0] = 1;
found_ind[get_global_id(0)] = 1;

dst[(get_global_id(0)<<1)] = (uint4) (TTE.s0,TTTA.s0,TTTB.s0,TTTC.s0);
dst[(get_global_id(0)<<1)+1] = (uint4)(TTE.s1,TTTA.s1,TTTB.s1,TTTC.s1);
...
uint TA,TB,TC,TD,TE;
uint TTA,TTB,TTC,TTD,TTE,TTF,TTTA,TTTB,TTTC;
...
w3=(uint)salt.s8;
SIZE=(uint)salt.s9;
w4=w5=w6=w7=w8=w9=w10=w11=w12=w13=w14=(uint)0;
...
if (((uint)(salt.sF&0xFFFF)!=((TTD)&0xFFFF))) return;

found[0] = 1;
found_ind[get_global_id(0)] = 1;

dst[(get_global_id(0))] = (uint4) (TTE,TTTA,TTTB,TTTC);
}
