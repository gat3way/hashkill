...
__kernel  void mysql5_short( __global uint *dst, uint4 input, uint size,  uint8 chbase, __global uint *found_ind, __global uint *bitmaps, __global uint *found, __global uint *table,  uint4 singlehash) 
{  
...
#define ROTATE1(a, b, c, d, e, x) e = K + e + x + rotate(a,S2) + F_00_19(b,c,d); b = rotate(b,S3) 
#define ROTATE1_NULL(a, b, c, d, e)  e = K + e + rotate(a,S2) + F_00_19(b,c,d); b = rotate(b,S3)
#define ROTATE2_F(a, b, c, d, e, x) e = e + x + rotate(a,S2) + F_20_39(b,c,d) + K; b = rotate(b,S3) 
#define ROTATE3_F(a, b, c, d, e, x) e = e + x + rotate(a,S2) + F_40_59(b,c,d) + K; b = rotate(b,S3)
#define ROTATE4_F(a, b, c, d, e, x) e = e + F_60_79(b,c,d) + rotate(a,S2) + x + K; b = rotate(b,S3)
...
__kernel  void mysql5_short( __global uint4 *dst, uint4 input, uint size,  uint8 chbase, __global uint *found_ind, __global uint *bitmaps, __global uint *found, __global uint *table,  uint4 singlehash) 
{  
