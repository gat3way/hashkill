...
#define AES256_GET_KEYS_E1 { \
k0=rk4;k1=rk5;k2=rk6;k3=rk7; \
}

#define AES256_GET_KEYS_E2 { \
temp = rk7; \
r8 = rk0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[0]; \
r9= rk1 ^ r8; \
...
#define AES256_GET_KEYS_E3 { \
k0=r4;k1=r5;k2=r6;k3=r7; \
}

#define AES256_GET_KEYS_E4 { \
temp = r7; \
r8 = r0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[1]; \
r9= r1 ^ r8; \
...
#define AES256_GET_KEYS_E5 { \
k0=r4;k1=r5;k2=r6;k3=r7; \
}


#define AES256_GET_KEYS_E6 { \
temp = r7; \
r8 = r0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[2]; \
r9= r1 ^ r8; \
...
#define AES256_GET_KEYS_E7 { \
k0=r4;k1=r5;k2=r6;k3=r7; \
}

#define AES256_GET_KEYS_E8 { \
temp = r7; \
r8 = r0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[3]; \
r9= r1 ^ r8; \
...
#define AES256_GET_KEYS_E9 { \
k0=r4;k1=r5;k2=r6;k3=r7; \
}

#define AES256_GET_KEYS_E10 { \
temp = r7; \
r8 = r0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[4]; \
r9= r1 ^ r8; \
...
#define AES256_GET_KEYS_E11 { \
k0=r4;k1=r5;k2=r6;k3=r7; \
}


#define AES256_GET_KEYS_E12 { \
temp = r7; \
r8 = r0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[5]; \
r9= r1 ^ r8; \
...
#define AES256_GET_KEYS_E13 { \
k0=r4;k1=r5;k2=r6;k3=r7; \
}

#define AES256_GET_KEYS_E14 { \
temp = r7; \
r8 = r0 ^(lTe2((temp >> 16) & 0xff) & 0xff000000) ^ (lTe3((temp >> 8) & 0xff) & 0x00ff0000)  \
^ (lTe[(temp) & 0xff] & 0x0000ff00) ^ (lTe1((temp >> 24)) & 0x000000ff) ^ rcon[6]; \
r9= r1 ^ r8; \
...
w6=g1;
w7=h1;
w8=w9=w10=w11=w12=w13=w14=(uint)0;
SIZE=size[get_global_id(0)]<<3;
...
__kernel 
__attribute__((reqd_work_group_size(64, 1, 1)))
void block( __global uint *dst,  __global uint *input, __global uint *size,  __global uint *found_ind, __global uint *found, uint16 singlehash,uint16 salt,uint16 str)
{
uint ib,ic,id;  
uint a1,b1,c1,d1,e1,f1,g1,h1; 
uint w0, w1, w2, w3, w4, w5, w6, w7,w8,w9,w10,w11,w12,w13,w14,w16;
...
Endian_Reverse32(rk4);
Endian_Reverse32(rk5);
Endian_Reverse32(rk6);
Endian_Reverse32(rk7);
...
__kernel 
__attribute__((reqd_work_group_size(64, 1, 1)))
void final( __global uint4 *dst,  __global uint *input, __global uint *size,  __global uint *found_ind, __global uint *found, uint16 singlehash,uint16 salt,uint16 str)
{
uint ib,ic,id;  
uint m = 0x00FF00FF;
uint m2 = 0xFF00FF00;
