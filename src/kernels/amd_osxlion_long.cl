...
void osxlion_long1( __global ulong4 *hashes, const ulong4 input, const uint size,  __global ulong2 *plains, __global uint *found,  ulong4 singlehash, ulong x0) 
{
...
osxlion_long_double( __global ulong4 *hashes,  const uint size,  __global ulong2 *plains, __global uint *found, __global const  uint *table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong i;
ulong j;
ulong k;
...
osxlion_long1(hashes,input, size, plains, found, singlehash,k);
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
osxlion_long_normal( __global ulong4 *hashes,  const uint size,  __global ulong2 *plains, __global uint *found, __global const  uint * table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong i;
ulong j,k;
ulong4 input;
...
void osxlion_long1( __global ulong4 *hashes, const ulong4 input, const uint size,  __global ulong2 *plains, __global uint *found,  ulong4 singlehash,ulong2 x0) 
{

ulong2 w0,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w16,SIZE;

uint i,ib,ic,id;  
ulong2 A,B,C,D,E,F,G,H,K,l,tmp1,tmp2,temp,T1,x2,x1,xx0;
uint b1,b2,b3,b4,b5,b6,b7,b8,b9,b10,b11,b12,b13,b14,b15,b16;
...
w0 = (ulong2)(x0);
w0 = w0<<32;
w0 = (ulong2)(w0|((input.x)));

w1=(ulong2)(input.z);
w1 = w1<<32;
w1=(ulong2)(w1|(input.y));
w2=(ulong2)(input.w);
w2 = w2<<32;
