...
id=get_global_id(0);
SIZE.s0=(ulong)((uint)size[id*2]); 
SIZE.s1=(ulong)((uint)size[id*2+1]); 


w0.s0=(ulong)input[id*4*2];
w1.s0=(ulong)input[id*4*2+1];
w2.s0=(ulong)input[id*4*2+2];
w3.s0=(ulong)input[id*4*2+3];
w0.s1=(ulong)input[id*4*2+4];
w1.s1=(ulong)input[id*4*2+5];
w2.s1=(ulong)input[id*4*2+6];
w3.s1=(ulong)input[id*4*2+7];
w2=w3=w4=w5=w6=w7=w8=w9=w10=w11=w12=w13=w14=w16=(ulong2)0;
