...
uint8 x0,x1,x2,x3; 
uint8 x4,x5,x6,x7,x8,x9,x10,x11,x12,temp; 
uint8 x[16];
...
x[salt.sE>>2] |= (uint8)ib<<((salt.sE&3)<<3);
x[(salt.sE+1)>>2] |= (uint8)ic<<(((salt.sE+1)&3)<<3);
x[(salt.sE+2)>>2] |= (uint8)id<<(((salt.sE+2)&3)<<3);
x[(salt.sE+3)>>2] |= (uint8)ie<<(((salt.sE+3)&3)<<3);
x[(salt.sE+4)>>2] |= chbase<<(((salt.sE+4)&3)<<3);
