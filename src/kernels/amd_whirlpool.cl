...
void whirlpoolblock( __global ulong4 *dst,ulong xx0,ulong xx1,ulong xx2,ulong xx3,ulong ssize,   __global uint *found_ind, __global uint *bitmaps, __global uint *found,  ulong4 singlehash,uint offset,__local ulong C0[256]) 
{
...
SIZE = (size+str.sC)<<3;
whirlpoolblock(dst,w0,w1,w2,w3,SIZE,found_ind,bitmaps,found,singlehash,0,C0);
...
whirlpoolblock(dst,w0,w1,w2,w3,SIZE,found_ind,bitmaps,found,singlehash,2,C0);
