...
void whirlpool_long1( __global ulong4 *hashes, const ulong4 input, const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found,  ulong4 singlehash, ulong x0, __local ulong C0[256]) 
{
ulong w0,w1,w2,w3,w4,w5,w6,SIZE;
uint i,ib,ic,id;  
...
whirlpool_long_double( __global ulong4 *hashes,  const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found, __global const  uint *table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong i;
ulong j;
ulong k;
...
whirlpool_long1(hashes,input, size, plains, bitmaps, found, singlehash,k,C0);
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
whirlpool_long_normal( __global ulong4 *hashes,  const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found, __global const  uint * table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong i;
ulong j,k;
ulong4 input;
...
void whirlpool_long1( __global ulong4 *hashes, const ulong4 input, const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found,  ulong4 singlehash,ulong2 x0,__local ulong C0[256]) 
{
ulong2 w0,w1,w2,w3,w4,w5,w6,SIZE;
uint i,ib,ic,id;  
