...
void sha512_long1( __global ulong2 *hashes, const ulong4 input, const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found,  ulong4 singlehash, ulong x0) 
{
...
#define H0 0xcbbb9d5dc1059ed8L
#define H1 0x629a292a367cd507L
#define H2 0x9159015a3070dd17L
#define H3 0x152fecd8f70e5939L
#define H4 0x67332667ffc00b31L
#define H5 0x8eb44a8768581511L
#define H6 0xdb0c2e0d64f98fa7L
#define H7 0x47b5481dbefa4fa4L

#define AC1  0x428a2f98d728ae22UL
#define AC2  0x7137449123ef65cdUL
#define AC3  0xb5c0fbcfec4d3b2fUL
#define AC4  0xe9b5dba58189dbbcUL
#define AC5  0x3956c25bf348b538UL
#define AC6  0x59f111f1b605d019UL
#define AC7  0x923f82a4af194f9bUL
#define AC8  0xab1c5ed5da6d8118UL
#define AC9  0xd807aa98a3030242UL
#define AC10 0x12835b0145706fbeUL
#define AC11 0x243185be4ee4b28cUL
#define AC12 0x550c7dc3d5ffb4e2UL
#define AC13 0x72be5d74f27b896fUL
#define AC14 0x80deb1fe3b1696b1UL
#define AC15 0x9bdc06a725c71235UL
#define AC16 0xc19bf174cf692694UL
#define AC17 0xe49b69c19ef14ad2UL
#define AC18 0xefbe4786384f25e3UL
#define AC19 0x0fc19dc68b8cd5b5UL
#define AC20 0x240ca1cc77ac9c65UL
#define AC21 0x2de92c6f592b0275UL
#define AC22 0x4a7484aa6ea6e483UL
#define AC23 0x5cb0a9dcbd41fbd4UL
#define AC24 0x76f988da831153b5UL
#define AC25 0x983e5152ee66dfabUL
#define AC26 0xa831c66d2db43210UL
#define AC27 0xb00327c898fb213fUL
#define AC28 0xbf597fc7beef0ee4UL
#define AC29 0xc6e00bf33da88fc2UL
#define AC30 0xd5a79147930aa725UL
#define AC31 0x06ca6351e003826fUL
#define AC32 0x142929670a0e6e70UL
#define AC33 0x27b70a8546d22ffcUL
#define AC34 0x2e1b21385c26c926UL
#define AC35 0x4d2c6dfc5ac42aedUL
#define AC36 0x53380d139d95b3dfUL
#define AC37 0x650a73548baf63deUL
#define AC38 0x766a0abb3c77b2a8UL
#define AC39 0x81c2c92e47edaee6UL
#define AC40 0x92722c851482353bUL
#define AC41 0xa2bfe8a14cf10364UL
#define AC42 0xa81a664bbc423001UL
#define AC43 0xc24b8b70d0f89791UL
#define AC44 0xc76c51a30654be30UL
#define AC45 0xd192e819d6ef5218UL
#define AC46 0xd69906245565a910UL
#define AC47 0xf40e35855771202aUL
#define AC48 0x106aa07032bbd1b8UL
#define AC49 0x19a4c116b8d2d0c8UL
#define AC50 0x1e376c085141ab53UL
#define AC51 0x2748774cdf8eeb99UL
#define AC52 0x34b0bcb5e19b48a8UL
#define AC53 0x391c0cb3c5c95a63UL
#define AC54 0x4ed8aa4ae3418acbUL
#define AC55 0x5b9cca4f7763e373UL
#define AC56 0x682e6ff3d6b2b8a3UL
#define AC57 0x748f82ee5defb2fcUL
#define AC58 0x78a5636f43172f60UL
#define AC59 0x84c87814a1f0ab72UL
#define AC60 0x8cc702081a6439ecUL
#define AC61 0x90befffa23631e28UL
#define AC62 0xa4506cebde82bde9UL
#define AC63 0xbef9a3f7b2c67915UL
#define AC64 0xc67178f2e372532bUL
#define AC65 0xca273eceea26619cUL
#define AC66 0xd186b8c721c0c207UL
#define AC67 0xeada7dd6cde0eb1eUL
#define AC68 0xf57d4f7fee6ed178UL
#define AC69 0x06f067aa72176fbaUL
#define AC70 0x0a637dc5a2c898a6UL
#define AC71 0x113f9804bef90daeUL
#define AC72 0x1b710b35131c471bUL
#define AC73 0x28db77f523047d84UL
#define AC74 0x32caab7b40c72493UL
#define AC75 0x3c9ebe0a15c9bebcUL
#define AC76 0x431d67c49c100d4cUL
#define AC77 0x4cc5d4becb3e42b6UL
#define AC78 0x597f299cfc657e2aUL
#define AC79 0x5fcb6fab3ad6faecUL
#define AC80 0x6c44198c4a475817UL
...
/*
#define Endian_Reverse64(a) { (a) = ((a) & 0x00000000000000FFUL) << 56UL | ((a) & 0x000000000000FF00UL) << 40UL | \
                              ((a) & 0x0000000000FF0000UL) << 24UL | ((a) & 0x00000000FF000000UL) << 8UL | \
                              ((a) & 0x000000FF00000000UL) >> 8UL | ((a) & 0x0000FF0000000000UL) >> 24UL | \
                              ((a) & 0x00FF000000000000UL) >> 40UL | ((a) & 0xFF00000000000000UL) >> 56UL; }
*/
...
found[0]++;
#endif
hashes[res*3]= (ulong2)(A,B);
hashes[res*3+1] = (ulong2)(C,D);
hashes[res*3+2] = (ulong2)(E,F);
...
sha384_long_double( __global ulong2 *hashes,  const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found, __global const  uint *table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong i;
ulong j;
ulong k;
...
i=(ulong)((uint)table[get_global_id(1)]);
j=(ulong)((uint)table[get_global_id(0)]<<16);
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha384_long_normal( __global ulong2 *hashes,  const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found, __global const  uint * table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong i;
ulong j,k;
ulong4 input;
...
i=(ulong)((uint)table[get_global_id(0)]<<16);
j=(ulong)((uint)table[get_global_id(1)]);
k=(i|j);
...
found[0]++;
#endif
hashes[res*3] = (ulong4)(A.s0,B.s0,C.s0,D.s0);
hashes[res*3+1] = (ulong4)(E.s0,F.s0,A.s1,B.s1);
hashes[res*3+2] = (ulong4)(C.s1,D.s1,E.s1,F.s1);
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha384_long_double( __global ulong4 *hashes,  const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found, __global const  uint *table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong2 i;
ulong j;
ulong2 k;
...
i.s0=(ulong)((uint)table[get_global_id(1)*2]);
i.s1=(ulong)((uint)table[get_global_id(1)*2+1]);
j=(ulong)((uint)table[get_global_id(0)]<<16);
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha384_long_normal( __global ulong4 *hashes,  const uint size,  __global ulong2 *plains, __global uint *bitmaps, __global uint *found, __global const  uint * table,const ulong16 chbase1,  const ulong16 chbase2) 
{
ulong2 i,k;
ulong2 j;
ulong4 input;
...
i.s0=(ulong)((uint)table[get_global_id(1)*2]);
i.s1=(ulong)((uint)table[get_global_id(1)*2+1]);
j=(ulong2)((uint)table[get_global_id(0)]<<16);
