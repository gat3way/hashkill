...
void mscash_short1( __global uint4 *dst,const uint4 input,const uint size, const uint8 chbase, __global uint *found_ind, __global const uint *bitmaps, __global uint *found, const uint i, const uint4 singlehash, uint factor,uint8 salt)
{  
