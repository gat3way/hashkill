#ifndef OLD_ATI
void mysql_old_short1( __global uint4 *dst, uint4 input, uint size,  uint8 chbase,  __global uint *found_ind, __global uint *bitmaps, __global uint *found, uint i,  uint4 singlehash, uint factor) 
{  
...
#ifdef DOUBLE
chbase1 = (uint8)(chbase.s8,chbase.s9,chbase.sA,chbase.sB,chbase.sC,chbase.sD,chbase.sE,chbase.sF);
mysql_old_short1(dst,input, size, chbase1, found_ind, bitmaps, found, i, singlehash,4);
#endif
}
...
__kernel void mysql_old_short( __global uint4 *dst, uint4 input, uint size,  uint16 chbase,  __global uint *found_ind, __global uint *bitmaps, __global uint *found, __global  uint *table,  uint4 singlehash) 
{  
