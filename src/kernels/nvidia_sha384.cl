...
sha384( __global ulong4 *dst,  __global uint *inp, __global uint *sizes,  __global uint *found_ind, __global uint *bitmaps, __global uint *found,  ulong4 singlehash,uint16 str) 
{
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha384( __global ulong2 *dst,  __global uint *inp, __global uint *sizes,  __global uint *found_ind, __global uint *bitmaps, __global uint *found,  ulong4 singlehash,uint16 str) 
{
ulong w0,w1,w2,w3,w4,w5,w6,w7,w8,w9,w10,w11,w12,w13,w14,w16,SIZE;
uint i,ib,ic,id;  
uint x0,x1,x2,x3,x4,x5,x6,x7;
