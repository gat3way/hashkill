...
lm_markov( __global uint4 *dst, uint4 input, uint size, uint4 chbase,  __global uint *found_ind, __global uint *bitmaps, __global uint *found, __global const uint *table,  uint4 singlehash) 
{
...
u1 = (((w2.x)&255)>>1)<<1;
u2 = ((((w2.x)&255)&0x01)<<6)<<1;
u2 |= (((w2.x>>8)&255)>>2)<<1;
u3 = ((((w2.x>>8)&255)&0x03)<<5)<<1;
u3 |= (((w2.x>>16)&255)>>3)<<1;
u4 = ((((w2.x>>16)&255)&0x07)<<4)<<1;
u4 |= (((w2.x>>24)&255)>>4)<<1;
u5 = ((((w2.x>>24)&255)&0x0F)<<3)<<1;
u5 |= (((w3.x)&255)>>5)<<1;
u6 = ((((w3.x)&255)&0x1F)<<2)<<1;
u6 |= (((w3.x>>8)&255)>>6)<<1;
u7 = ((((w3.x>>8)&255)&0x3F)<<1)<<1;
u7 |= (((w3.x>>16)&255)>>7)<<1;
u8 = (((w3.x>>16)&255)&0x7F)<<1;
t0.x=(u1|(u2<<8)|(u3<<16)|(u4<<24));
t1.x=(uint)(u5|(u6<<8)|(u7<<16)|(u8<<24));
u1 = (((w2.y)&255)>>1)<<1;
u2 = ((((w2.y)&255)&0x01)<<6)<<1;
u2 |= (((w2.y>>8)&255)>>2)<<1;
u3 = ((((w2.y>>8)&255)&0x03)<<5)<<1;
u3 |= (((w2.y>>16)&255)>>3)<<1;
u4 = ((((w2.y>>16)&255)&0x07)<<4)<<1;
u4 |= (((w2.y>>24)&255)>>4)<<1;
u5 = ((((w2.y>>24)&255)&0x0F)<<3)<<1;
u5 |= (((w3.y)&255)>>5)<<1;
u6 = ((((w3.y)&255)&0x1F)<<2)<<1;
u6 |= (((w3.y>>8)&255)>>6)<<1;
u7 = ((((w3.y>>8)&255)&0x3F)<<1)<<1;
u7 |= (((w3.y>>16)&255)>>7)<<1;
u8 = (((w3.y>>16)&255)&0x7F)<<1;
t0.y=(u1|(u2<<8)|(u3<<16)|(u4<<24));
t1.y=(uint)(u5|(u6<<8)|(u7<<16)|(u8<<24));
