...
#ifdef SM21
void mysql_old_markov1( __global uint4 *dst, uint4 input, uint size,  uint4 chbase,  __global uint *found_ind, __global uint *bitmaps, __global uint *found, uint i,  uint4 singlehash, uint factor) 
{  
...
mysql_old_markov1(dst,input, size, chbase1, found_ind, bitmaps, found, i, singlehash,2);
#endif
...
__kernel void mysql_old_markov( __global uint2 *dst, uint4 input, uint size,  uint16 chbase,  __global uint *found_ind, __global uint *bitmaps, __global uint *found, __global  uint *table,  uint4 singlehash) 
{  
