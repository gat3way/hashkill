...
oracle_old_markov( __global uint4 *dst, uint4 input, uint size,  uint4 chbase,  __global uint *found_ind, uint16 salt, __global uint *found, __global  uint *table,  uint4 singlehash) 
{
...
if (salt.sE==1) {w0|=(ia<<24);w1=(ib<<8)|(ic<<24);w2|=(chbase1<<8);}
else if (salt.sE==2) {w1=(ia<<8)|(ib<<24);w2=(ic<<8)|(chbase1<<24);}
else if (salt.sE==3) {w1|=(ia<<24);w2=(ib<<8)|(ic<<24);w3|=(chbase1<<8);}
else if (salt.sE==4) {w2=(ia<<8)|(ib<<24);w3=(ic<<8)|(chbase1<<24);}
else if (salt.sE==5) {w2|=(ia<<24);w3=(ib<<8)|(ic<<24);w4|=(chbase1<<8);}
else if (salt.sE==6) {w3=(ia<<8)|(ib<<24);w4=(uint2)(ic<<8)|(chbase1<<24);}
else if (salt.sE==7) {w3|=(ia<<24);w4=(ib<<8)|(ic<<24);w5|=(chbase1<<8);}
else if (salt.sE==8) {w4=(ia<<8)|(ib<<24);w5=(ic<<8)|(chbase1<<24);}
else if (salt.sE==9) {w4|=(ia<<24);w5=(ib<<8)|(ic<<24);w6|=(chbase1<<8);}
else if (salt.sE==10) {w5=(ia<<8)|(ib<<24);w6=(ic<<8)|(chbase1<<24);}
else if (salt.sE==11) {w5|=(ia<<24);w6=(ib<<8)|(ic<<24);w7|=(chbase1<<8);}
else if (salt.sE==12) {w6=(ia<<8)|(ib<<24);w7=(ic<<8)|(chbase1<<24);}
