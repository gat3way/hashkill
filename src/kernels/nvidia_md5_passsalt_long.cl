...
void md5_passsalt_long1( __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains, __global uint *found,  uint4 singlehash,uint4 k, uint16 salt) 
{
...
uint4 x0,x1,x2,x3; 
uint4 x4,x5,x6,x7,x8,x9,x10,x11,x12; 
...
t2=(uint4)(singlehash.y)-((uint4)(singlehash.z^singlehash.w)^t1);
