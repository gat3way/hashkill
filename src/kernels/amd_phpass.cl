...
x4.x=input[(get_global_id(0)*32)];
x5.x=input[(get_global_id(0)*32)+1];
x6.x=input[(get_global_id(0)*32)+2];
x7.x=input[(get_global_id(0)*32)+3];
x8.x=input[(get_global_id(0)*32)+4];
x9.x=input[(get_global_id(0)*32)+5];
x10.x=input[(get_global_id(0)*32)+6];
x11.x=input[(get_global_id(0)*32)+7];


x4.y=input[(get_global_id(0)*32)+8];
x5.y=input[(get_global_id(0)*32)+9];
x6.y=input[(get_global_id(0)*32)+10];
x7.y=input[(get_global_id(0)*32)+11];
x8.y=input[(get_global_id(0)*32)+12];
x9.y=input[(get_global_id(0)*32)+13];
x10.y=input[(get_global_id(0)*32)+14];
x11.y=input[(get_global_id(0)*32)+15];

x4.z=input[(get_global_id(0)*32)+16];
x5.z=input[(get_global_id(0)*32)+17];
x6.z=input[(get_global_id(0)*32)+18];
x7.z=input[(get_global_id(0)*32)+19];
x8.z=input[(get_global_id(0)*32)+20];
x9.z=input[(get_global_id(0)*32)+21];
x10.z=input[(get_global_id(0)*32)+22];
x11.z=input[(get_global_id(0)*32)+23];

x4.w=input[(get_global_id(0)*32)+24];
x5.w=input[(get_global_id(0)*32)+25];
x6.w=input[(get_global_id(0)*32)+26];
x7.w=input[(get_global_id(0)*32)+27];
x8.w=input[(get_global_id(0)*32)+28];
x9.w=input[(get_global_id(0)*32)+29];
x10.w=input[(get_global_id(0)*32)+30];
x11.w=input[(get_global_id(0)*32)+31];
...
x4=input[(get_global_id(0)*8)];
x5=input[(get_global_id(0)*8)+1];
x6=input[(get_global_id(0)*8)+2];
x7=input[(get_global_id(0)*8)+3];
x8=input[(get_global_id(0)*8)+4];
x9=input[(get_global_id(0)*8)+5];
x10=input[(get_global_id(0)*8)+6];
x11=input[(get_global_id(0)*8)+7];
