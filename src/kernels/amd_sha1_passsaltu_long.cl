...
sha1_passsalt_long_double( __global uint *hashes,  const uint size,  __global uint4 *plains, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4,uint16 chbase5,uint16 chbase6) 
{
uint i;
uint j,k;
uint c0,x0;
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha1_passsalt_long_normal( __global uint *hashes,  const uint size,  __global uint4 *plains, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4,uint16 chbase5,uint16 chbase6) 
{
uint i;
uint j,k;
uint c0,x0;
...
void sha1_passsalt_long1( __global uint4 *hashes, const uint4 input, const uint size,  __global uint4 *plains, __global uint *found,  uint4 singlehash,uint4 k, uint16 salt) 
{
...
SIZE = (uint4)salt.sE; 
w0 = (uint4)((k&255)|(((k>>8)&255)<<16)); 
w1 = (uint4)(((k>>16)&255)|(((k>>24)&255)<<16)); 
w2 = salt.s0;
w3 = salt.s1;
w4 = salt.s2;
w5 = salt.s3;
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha1_passsalt_long_double( __global uint4 *hashes,  const uint size,  __global uint4 *plains, __global uint *found, __global const  uint *table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4,uint16 chbase5,uint16 chbase6) 
{
uint4 i;
uint j;
uint4 k;
...
__kernel void  __attribute__((reqd_work_group_size(64, 1, 1))) 
sha1_passsalt_long_normal( __global uint4 *hashes,  const uint size,  __global uint4 *plains, __global uint *found, __global const  uint * table,const uint16 chbase1,  const uint16 chbase2,uint16 chbase3,uint16 chbase4,uint16 chbase5,uint16 chbase6) 
{
uint4 i,k;
uint j;
uint4 input;
