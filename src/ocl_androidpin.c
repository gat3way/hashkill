...
#define REVERSE_MD5STEP(a,b,c,d,x,s,AC) a = ROTATE_RIGHT((a - b), s) - (unsigned int)x - (AC) - I(b, c, d);
...
#define SETUP_PARAMS() { \
        ...
        C=(C-0x98badcfe); \
        D=(D-0x10325476); \
        REVERSE_MD5STEP(B, C, D, A, salt.s8,      S44, AC64); \
        REVERSE_MD5STEP(C, D, A, B, salt.s1,      S43, AC63); \
        REVERSE_MD5STEP(D, A, B, C, 0,      	  S42, AC62); \
        REVERSE_MD5STEP(A, B, C, D, salt.s3,      S41, AC61); \
        REVERSE_MD5STEP(B, C, D, A, 0,     	  S44, AC60); \
        REVERSE_MD5STEP(C, D, A, B, salt.s5,      S43, AC59); \
        REVERSE_MD5STEP(D, A, B, C, 0,     	  S42, AC58); \
        REVERSE_MD5STEP(A, B, C, D, salt.s7,      S41, AC57); \
        REVERSE_MD5STEP(B, C, D, A, salt.s0,      S44, AC56); \
        REVERSE_MD5STEP(C, D, A, B, salt.s9,      S43, AC55); \
        REVERSE_MD5STEP(D, A, B, C, salt.s2,      S42, AC54); \
        REVERSE_MD5STEP(A, B, C, D, 0,     	  S41, AC53); \
        REVERSE_MD5STEP(B, C, D, A, salt.s4,      S44, AC52); \
        REVERSE_MD5STEP(C, D, A, B, salt.sE,      S43, AC51); \
        REVERSE_MD5STEP(D, A, B, C, salt.s6,      S42, AC50); \
        REVERSE_MD5STEP(A, B, C, D, 0,    	  S41, AC49); \
        B = ROTATE_RIGHT((B - C), 23) - salt.s1 - 0xc4ac5665; \
        image.x=0; \
...
static cl_uint16 setup_salt(char *salt, char *plain)
{
    ...
    switch (strlen(plain))
    {
        case 0:
            ...
            t.sF=strlen(salt)+strlen(plain);
            break;


        case 1:
            t.s0=(plain[0]&255)|((salt2[0]&255)<<8)|((salt2[1]&255)<<16)|((salt2[2]&255)<<24);
            t.s1=(salt2[3]&255)|((salt2[4]&255)<<8)|((salt2[5]&255)<<16)|((salt2[6]&255)<<24);
            t.s2=(salt2[7]&255)|((salt2[8]&255)<<8)|((salt2[9]&255)<<16)|((salt2[10]&255)<<24);
            t.s3=(salt2[11]&255)|((salt2[12]&255)<<8)|((salt2[13]&255)<<16)|((salt2[14]&255)<<24);
            t.s4=(salt2[15]&255)|((salt2[16]&255)<<8)|((salt2[17]&255)<<16)|((salt2[18]&255)<<24);
            t.s5=(salt2[19]&255)|((salt2[20]&255)<<8)|((salt2[21]&255)<<16)|((salt2[22]&255)<<24);
            t.s6=(salt2[23]&255)|((salt2[24]&255)<<8)|((salt2[25]&255)<<16)|((salt2[26]&255)<<24);
            t.s7=(salt2[27]&255)|((salt2[28]&255)<<8)|((salt2[29]&255)<<16)|((salt2[30]&255)<<24);
            t.s8=(salt2[31]&255)|((salt2[32]&255)<<8)|((salt2[33]&255)<<16)|((salt2[34]&255)<<24);
            t.s9=(salt2[35]&255)|((salt2[36]&255)<<8)|((salt2[37]&255)<<16)|((salt2[38]&255)<<24);
            t.sA=(salt2[39]&255)|((salt2[40]&255)<<8)|((salt2[41]&255)<<16)|((salt2[42]&255)<<24);
           t.sB=(salt2[43]&255)|((salt2[44]&255)<<8)|((salt2[45]&255)<<16)|((salt2[46]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;

        case 2:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((salt2[0]&255)<<16)|((salt2[1]&255)<<24);
        ...
        case 3:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((salt2[0]&255)<<24);
            t.s1=(salt2[1]&255)|((salt2[2]&255)<<8)|((salt2[3]&255)<<16)|((salt2[4]&255)<<24);
            t.s2=(salt2[5]&255)|((salt2[6]&255)<<8)|((salt2[7]&255)<<16)|((salt2[8]&255)<<24);
            t.s3=(salt2[9]&255)|((salt2[10]&255)<<8)|((salt2[11]&255)<<16)|((salt2[12]&255)<<24);
            t.s4=(salt2[13]&255)|((salt2[14]&255)<<8)|((salt2[15]&255)<<16)|((salt2[16]&255)<<24);
            t.s5=(salt2[17]&255)|((salt2[18]&255)<<8)|((salt2[19]&255)<<16)|((salt2[20]&255)<<24);
            t.s6=(salt2[21]&255)|((salt2[22]&255)<<8)|((salt2[23]&255)<<16)|((salt2[24]&255)<<24);
            t.s7=(salt2[25]&255)|((salt2[26]&255)<<8)|((salt2[27]&255)<<16)|((salt2[28]&255)<<24);
            t.s8=(salt2[29]&255)|((salt2[30]&255)<<8)|((salt2[31]&255)<<16)|((salt2[32]&255)<<24);
            t.s9=(salt2[33]&255)|((salt2[34]&255)<<8)|((salt2[35]&255)<<16)|((salt2[36]&255)<<24);
            t.sA=(salt2[37]&255)|((salt2[38]&255)<<8)|((salt2[39]&255)<<16)|((salt2[40]&255)<<24);
            t.sB=(salt2[41]&255)|((salt2[42]&255)<<8)|((salt2[43]&255)<<16)|((salt2[44]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;

        case 4:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            ...
            t.s4=(salt2[12]&255)|((salt2[13]&255)<<8)|((salt2[14]&255)<<16)|((salt2[15]&255)<<24);
            t.s5=(salt2[16]&255)|((salt2[17]&255)<<8)|((salt2[18]&255)<<16)|((salt2[19]&255)<<24);
            t.s6=(salt2[20]&255)|((salt2[21]&255)<<8)|((salt2[22]&255)<<16)|((salt2[23]&255)<<24);
            t.s7=(salt2[24]&255)|((salt2[25]&255)<<8)|((salt2[26]&255)<<16)|((salt2[27]&255)<<24);
            t.s8=(salt2[28]&255)|((salt2[29]&255)<<8)|((salt2[30]&255)<<16)|((salt2[31]&255)<<24);
            t.s9=(salt2[32]&255)|((salt2[33]&255)<<8)|((salt2[34]&255)<<16)|((salt2[35]&255)<<24);
            t.sA=(salt2[36]&255)|((salt2[37]&255)<<8)|((salt2[38]&255)<<16)|((salt2[39]&255)<<24);
            t.sB=(salt2[40]&255)|((salt2[41]&255)<<8)|((salt2[42]&255)<<16)|((salt2[43]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;

        case 5:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            t.s1=(plain[4]&255)|((salt2[0]&255)<<8)|((salt2[1]&255)<<16)|((salt2[2]&255)<<24);
            t.s2=(salt2[3]&255)|((salt2[4]&255)<<8)|((salt2[5]&255)<<16)|((salt2[6]&255)<<24);
            t.s3=(salt2[7]&255)|((salt2[8]&255)<<8)|((salt2[9]&255)<<16)|((salt2[10]&255)<<24);
            t.s4=(salt2[11]&255)|((salt2[12]&255)<<8)|((salt2[13]&255)<<16)|((salt2[14]&255)<<24);
            t.s5=(salt2[15]&255)|((salt2[16]&255)<<8)|((salt2[17]&255)<<16)|((salt2[18]&255)<<24);
            t.s6=(salt2[19]&255)|((salt2[20]&255)<<8)|((salt2[21]&255)<<16)|((salt2[22]&255)<<24);
            t.s7=(salt2[23]&255)|((salt2[24]&255)<<8)|((salt2[25]&255)<<16)|((salt2[26]&255)<<24);
            t.s8=(salt2[27]&255)|((salt2[28]&255)<<8)|((salt2[29]&255)<<16)|((salt2[30]&255)<<24);
            t.s9=(salt2[31]&255)|((salt2[32]&255)<<8)|((salt2[33]&255)<<16)|((salt2[34]&255)<<24);
            t.sA=(salt2[35]&255)|((salt2[36]&255)<<8)|((salt2[37]&255)<<16)|((salt2[38]&255)<<24);
            t.sB=(salt2[39]&255)|((salt2[40]&255)<<8)|((salt2[41]&255)<<16)|((salt2[42]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;
        case 6:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            t.s1=(plain[4]&255)|((plain[5]&255)<<8)|((salt2[0]&255)<<16)|((salt2[1]&255)<<24);
            t.s2=(salt2[2]&255)|((salt2[3]&255)<<8)|((salt2[4]&255)<<16)|((salt2[5]&255)<<24);
            t.s3=(salt2[6]&255)|((salt2[7]&255)<<8)|((salt2[8]&255)<<16)|((salt2[9]&255)<<24);
            t.s4=(salt2[10]&255)|((salt2[11]&255)<<8)|((salt2[12]&255)<<16)|((salt2[13]&255)<<24);
            t.s5=(salt2[14]&255)|((salt2[15]&255)<<8)|((salt2[16]&255)<<16)|((salt2[17]&255)<<24);
            t.s6=(salt2[18]&255)|((salt2[19]&255)<<8)|((salt2[20]&255)<<16)|((salt2[21]&255)<<24);
            t.s7=(salt2[22]&255)|((salt2[23]&255)<<8)|((salt2[24]&255)<<16)|((salt2[25]&255)<<24);
            t.s8=(salt2[26]&255)|((salt2[27]&255)<<8)|((salt2[28]&255)<<16)|((salt2[29]&255)<<24);
            t.s9=(salt2[30]&255)|((salt2[31]&255)<<8)|((salt2[32]&255)<<16)|((salt2[33]&255)<<24);
            t.sA=(salt2[34]&255)|((salt2[35]&255)<<8)|((salt2[36]&255)<<16)|((salt2[37]&255)<<24);
            t.sB=(salt2[38]&255)|((salt2[39]&255)<<8)|((salt2[40]&255)<<16)|((salt2[41]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;

        case 7:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            t.s1=(plain[4]&255)|((plain[5]&255)<<8)|((plain[6]&255)<<16)|((salt2[0]&255)<<24);
            t.s2=(salt2[1]&255)|((salt2[2]&255)<<8)|((salt2[3]&255)<<16)|((salt2[4]&255)<<24);
            t.s3=(salt2[5]&255)|((salt2[6]&255)<<8)|((salt2[7]&255)<<16)|((salt2[8]&255)<<24);
            t.s4=(salt2[9]&255)|((salt2[10]&255)<<8)|((salt2[11]&255)<<16)|((salt2[12]&255)<<24);
            t.s5=(salt2[13]&255)|((salt2[14]&255)<<8)|((salt2[15]&255)<<16)|((salt2[16]&255)<<24);
            t.s6=(salt2[17]&255)|((salt2[18]&255)<<8)|((salt2[19]&255)<<16)|((salt2[20]&255)<<24);
            t.s7=(salt2[21]&255)|((salt2[22]&255)<<8)|((salt2[23]&255)<<16)|((salt2[24]&255)<<24);
            t.s8=(salt2[25]&255)|((salt2[26]&255)<<8)|((salt2[27]&255)<<16)|((salt2[28]&255)<<24);
            t.s9=(salt2[29]&255)|((salt2[30]&255)<<8)|((salt2[31]&255)<<16)|((salt2[32]&255)<<24);
            t.sA=(salt2[33]&255)|((salt2[34]&255)<<8)|((salt2[35]&255)<<16)|((salt2[36]&255)<<24);
            t.sB=(salt2[37]&255)|((salt2[38]&255)<<8)|((salt2[39]&255)<<16)|((salt2[40]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;

        case 8:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            t.s1=(plain[4]&255)|((plain[5]&255)<<8)|((plain[6]&255)<<16)|((plain[7]&255)<<24);
            t.s2=(salt2[0]&255)|((salt2[1]&255)<<8)|((salt2[2]&255)<<16)|((salt2[3]&255)<<24);
            t.s3=(salt2[4]&255)|((salt2[5]&255)<<8)|((salt2[6]&255)<<16)|((salt2[7]&255)<<24);
            t.s4=(salt2[8]&255)|((salt2[9]&255)<<8)|((salt2[10]&255)<<16)|((salt2[11]&255)<<24);
            t.s5=(salt2[12]&255)|((salt2[13]&255)<<8)|((salt2[14]&255)<<16)|((salt2[15]&255)<<24);
            t.s6=(salt2[16]&255)|((salt2[17]&255)<<8)|((salt2[18]&255)<<16)|((salt2[19]&255)<<24);
            t.s7=(salt2[20]&255)|((salt2[21]&255)<<8)|((salt2[22]&255)<<16)|((salt2[23]&255)<<24);
            t.s8=(salt2[24]&255)|((salt2[25]&255)<<8)|((salt2[26]&255)<<16)|((salt2[27]&255)<<24);
            t.s9=(salt2[28]&255)|((salt2[29]&255)<<8)|((salt2[30]&255)<<16)|((salt2[31]&255)<<24);
            t.sA=(salt2[32]&255)|((salt2[33]&255)<<8)|((salt2[34]&255)<<16)|((salt2[35]&255)<<24);
            t.sB=(salt2[36]&255)|((salt2[37]&255)<<8)|((salt2[38]&255)<<16)|((salt2[39]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;
        ...
        case 9:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            t.s1=(plain[4]&255)|((plain[5]&255)<<8)|((plain[6]&255)<<16)|((plain[7]&255)<<24);
            t.s2=(plain[8]&255)|((salt2[0]&255)<<8)|((salt2[1]&255)<<16)|((salt2[2]&255)<<24);
            t.s3=(salt2[3]&255)|((salt2[4]&255)<<8)|((salt2[5]&255)<<16)|((salt2[6]&255)<<24);
            t.s4=(salt2[7]&255)|((salt2[8]&255)<<8)|((salt2[9]&255)<<16)|((salt2[10]&255)<<24);
            t.s5=(salt2[11]&255)|((salt2[12]&255)<<8)|((salt2[13]&255)<<16)|((salt2[14]&255)<<24);
            t.s6=(salt2[15]&255)|((salt2[16]&255)<<8)|((salt2[17]&255)<<16)|((salt2[18]&255)<<24);
            t.s7=(salt2[19]&255)|((salt2[20]&255)<<8)|((salt2[21]&255)<<16)|((salt2[22]&255)<<24);
            t.s8=(salt2[23]&255)|((salt2[24]&255)<<8)|((salt2[25]&255)<<16)|((salt2[26]&255)<<24);
            t.s9=(salt2[27]&255)|((salt2[28]&255)<<8)|((salt2[29]&255)<<16)|((salt2[30]&255)<<24);
            t.sA=(salt2[31]&255)|((salt2[32]&255)<<8)|((salt2[33]&255)<<16)|((salt2[34]&255)<<24);
            t.sB=(salt2[35]&255)|((salt2[36]&255)<<8)|((salt2[37]&255)<<16)|((salt2[38]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;
        case 10:
            t.s0=(plain[0]&255)|((plain[1]&255)<<8)|((plain[2]&255)<<16)|((plain[3]&255)<<24);
            t.s1=(plain[4]&255)|((plain[5]&255)<<8)|((plain[6]&255)<<16)|((plain[7]&255)<<24);
            t.s2=(plain[8]&255)|((plain[9]&255)<<8)|((salt2[0]&255)<<16)|((salt2[1]&255)<<24);
            t.s3=(salt2[2]&255)|((salt2[3]&255)<<8)|((salt2[4]&255)<<16)|((salt2[5]&255)<<24);
            t.s4=(salt2[6]&255)|((salt2[7]&255)<<8)|((salt2[8]&255)<<16)|((salt2[9]&255)<<24);
            t.s5=(salt2[10]&255)|((salt2[11]&255)<<8)|((salt2[12]&255)<<16)|((salt2[13]&255)<<24);
            t.s6=(salt2[14]&255)|((salt2[15]&255)<<8)|((salt2[16]&255)<<16)|((salt2[17]&255)<<24);
            t.s7=(salt2[18]&255)|((salt2[19]&255)<<8)|((salt2[20]&255)<<16)|((salt2[21]&255)<<24);
            t.s8=(salt2[22]&255)|((salt2[23]&255)<<8)|((salt2[24]&255)<<16)|((salt2[25]&255)<<24);
            t.s9=(salt2[26]&255)|((salt2[27]&255)<<8)|((salt2[28]&255)<<16)|((salt2[29]&255)<<24);
            t.sA=(salt2[30]&255)|((salt2[31]&255)<<8)|((salt2[32]&255)<<16)|((salt2[33]&255)<<24);
            t.sB=(salt2[34]&255)|((salt2[35]&255)<<8)|((salt2[36]&255)<<16)|((salt2[37]&255)<<24);
            t.sF=strlen(salt)+strlen(plain);
            break;
...
void* ocl_bruteforce_androidpin_thread(void *arg)
{
    int err;
    ...
    /* Init kernels */
    if (ocl_gpu_double) kernel = _clCreateKernel(program[self], "md5_passsalt_long_double", &err );
    else  kernel = _clCreateKernel(program[self], "md5_passsalt_long_normal", &err );
...
void* ocl_markov_androidpin_thread(void *arg)
{
    int err;
    cl_command_queue queue;
    cl_mem hashes_buf;
...
/* Crack callback */
static void ocl_androidpin_crack_callback(char *line, int self)
{
    int a,b,c,e;
    int *found;
    int err;
	...
	while (mylist)
	{
	    ...
	    salt.sF=strlen(line);
	    salt.s0=mylist->salt[0]|(mylist->salt[1]<<8)|(mylist->salt[2]<<16)|(mylist->salt[3]<<24);
	    salt.s1=mylist->salt[4]|(mylist->salt[5]<<8)|(mylist->salt[6]<<16)|(mylist->salt[7]<<24);
	    salt.s2=mylist->salt[8]|(mylist->salt[9]<<8)|(mylist->salt[10]<<16)|(mylist->salt[11]<<24);
	    salt.s3=mylist->salt[12]|(mylist->salt[13]<<8)|(mylist->salt[14]<<16)|(mylist->salt[15]<<24);
	    salt.s4=mylist->salt[16]|(mylist->salt[17]<<8)|(mylist->salt[18]<<16)|(mylist->salt[19]<<24);
	    salt.s5=mylist->salt[20]|(mylist->salt[21]<<8)|(mylist->salt[22]<<16)|(mylist->salt[23]<<24);
	    salt.s6=mylist->salt[24]|(mylist->salt[25]<<8)|(mylist->salt[26]<<16)|(mylist->salt[27]<<24);
	    salt.s7=mylist->salt[28]|(mylist->salt[29]<<8)|(mylist->salt[30]<<16)|(mylist->salt[31]<<24);
	    salt.sF = strlen(mylist->salt);
...
static void ocl_androidpin_callback(char *line, int self)
{
	...
	ocl_rule_opt_counts[self]=0;
	rule_offload_perform(ocl_androidpin_crack_callback,self);
...
void* ocl_rule_androidpin_thread(void *arg)
{
    cl_int err;
    int found;
    ...
    rule_kernel[self] = _clCreateKernel(program[self], "md5_passsalt", &err );
    ...
    worker_gen(self,ocl_androidpin_callback);
...
hash_stat ocl_bruteforce_androidpin(void)
{
    ...
    for (i=0;i<nwthreads;i++) if (wthreads[i].type!=cpu_thread)
    {
    	...
    	if (wthreads[i].type != nv_thread)
    	{
    	    ...
    	    sprintf(kernelfile,"%s/hashkill/kernels/amd_md5_passsalt_long__%s.bin",DATADIR,pbuf);
	    ...
	    if ((compute_capability_major==3)&&(compute_capability_minor==0)) sprintf(pbuf,"sm30");
    	    sprintf(kernelfile,"%s/hashkill/kernels/nvidia_md5_passsalt_long__%s.ptx",DATADIR,pbuf);
    ...
    for (a=0;a<nwthreads;a++) if (wthreads[a].type!=cpu_thread)
    {
        ...
        pthread_create(&crack_threads[a], NULL, ocl_bruteforce_androidpin_thread, &worker_thread_keys[a]);
    }
...
hash_stat ocl_markov_androidpin(void)
{
    ...
    {
	worker_thread_keys[a]=a;
	pthread_create(&crack_threads[a], NULL, ocl_markov_androidpin_thread, &worker_thread_keys[a]);
    }
...
hash_stat ocl_rule_androidpin(void)
{
	...
	_clGetDeviceIDs(platform[wthreads[i].platform], CL_DEVICE_TYPE_GPU, 64, device, (cl_uint *)&devicesnum);
        ...
        if (wthreads[i].type != nv_thread)
        {
            ...
            char kernelfile[255];
            _clGetDeviceInfo(device[wthreads[i].deviceid], CL_DEVICE_NAME, sizeof(pbuf),pbuf, NULL );
    	    sprintf(kernelfile,"%s/hashkill/kernels/amd_md5_passsalt__%s.bin",DATADIR,pbuf);
        ...
        else
        {
            ...
            if ((compute_capability_major==2)&&(compute_capability_minor==1)) sprintf(pbuf,"sm21");
	    if ((compute_capability_major==3)&&(compute_capability_minor==0)) sprintf(pbuf,"sm30");
    	    sprintf(kernelfile,"%s/hashkill/kernels/nvidia_md5_passsalt__%s.ptx",DATADIR,pbuf);
    ...
    {
        worker_thread_keys[a]=a;
        pthread_create(&crack_threads[a], NULL, ocl_rule_androidpin_thread, &worker_thread_keys[a]);
    }
    rule_gen_parse(rule_file,ocl_androidpin_callback,nwthreads,SELF_THREAD);
