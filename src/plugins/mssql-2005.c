...
{
    return("mssql-2005 \tMicrosoft SQL Server 2005 plugin");
}
...
char * hash_plugin_detailed(void)
{
    return("mssql-2005 - Microsoft SQL Server 2005 plugin\n"
	    "------------------------\n"
	    "Use this module to crack MS-SQL 2005 pwdencrypt() hashes\n"
