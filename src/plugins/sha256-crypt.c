...
char *
__sha256_crypt_r (key, salt, buffer, buflen, vectorsize)
     ...
     int vectorsize;
{
  ...
  for (i=0;i<vectorsize;i++)
  {
    ...
    b64_from_24bit (alt_result[i][0], alt_result[i][10], alt_result[i][20], 4);
    b64_from_24bit (alt_result[i][21], alt_result[i][1], alt_result[i][11], 4);
    b64_from_24bit (alt_result[i][12], alt_result[i][22], alt_result[i][2], 4);
    b64_from_24bit (alt_result[i][3], alt_result[i][13], alt_result[i][23], 4);
    b64_from_24bit (alt_result[i][24], alt_result[i][4], alt_result[i][14], 4);
    b64_from_24bit (alt_result[i][15], alt_result[i][25], alt_result[i][5], 4);
    b64_from_24bit (alt_result[i][6], alt_result[i][16], alt_result[i][26], 4);
    b64_from_24bit (alt_result[i][27], alt_result[i][7], alt_result[i][17], 4);
