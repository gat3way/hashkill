...
(tmp1) = _mm_set1_epi32(AC); \
(a) = _mm_add_epi32(a,(tmp1)); \
(a2) = _mm_add_epi32((a2),(tmp1)); \
(a3) = _mm_add_epi32((a3),(tmp1)); \
(a) = _mm_add_epi32((a),(x)); \
...
(tmp1) = _mm_cmov_si128((b),(c),(d)); \
(tmp1_2) = _mm_cmov_si128((b2),(c2),(d2)); \
(tmp1_3) = _mm_cmov_si128((b3),(c3),(d3)); \
(a) = _mm_add_epi32((a),tmp1); \
(a2) = _mm_add_epi32((a2),tmp1_2); \
(a3) = _mm_add_epi32((a3),tmp1_3); \
(tmp1) = _mm_set1_epi32(AC); \
