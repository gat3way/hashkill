...
hash_stat MD4_XOP(char *plains[12], char *hash[12], int lens[12])
{
    ...
    __m128i w03, w13, w23, w33, w43, w53, w63, w73, w143;


    __m128i a, b, c, d, AC, AD;
    __m128i a2, b2, c2, d2, tmp1, tmp1_2, tmp1_3, tmp1_4;
    __m128i a3, b3, c3, d3 ;
    __m128i a4, b4, c4, d4 ;
...
hash_stat MD4_XOP_SHORT(char *plains[12], char *hash[12], int lens[12])
{

    __m128i w0, w1, w2, w3, w14;
    __m128i w01, w11, w21, w31, w141;
    __m128i w02, w12, w22, w32, w142;
    __m128i w03, w13, w23, w33, w143;
...
hash_stat MD4_XOP_FIXED(char *plains[16], char *hash[16], int lens)
{
...
#define _mm_extract_epi32(x, imm) \
    ...
    if (lens<15)
    {
	w4=w41=w42=w43=w5=w51=w52=w53=w6=w61=w62=w63=w7=w71=w72=w73=_mm_set_epi32(0,0,0,0);
    }
    else
    {
	w4 = _mm_set_epi32(udata1[4],udata2[4],udata3[4],udata7[4]);
...
hash_stat MD4_XOP_SHORT_FIXED(char *plains[16], char *hash[16], int lens)
{
