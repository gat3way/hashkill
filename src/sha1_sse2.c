...
hash_stat SHA1_SSE_SHORT(char *plains[VSIZE], char *hash[VSIZE], int lens[VSIZE])
{
    ...
    __m128i sse_K, tmp1, tmp2, tmp3, tmp1_1, tmp1_2, tmp2_1, tmp2_2, tmp3_1, tmp3_2;
...
hash_stat SHA1_SSE(char *plains[VSIZE], char *hash[VSIZE], int lens[VSIZE])
{
...
hash_stat SHA1_SSE_SHORT_FIXED(char *plains[VSIZE], char *hash[VSIZE], int lens)
{
    const __m128i m=_mm_set1_epi32(0x00FF00FFUL);
    const __m128i m2=_mm_set1_epi32(0xFF00FF00UL);
    int t;
...
hash_stat SHA1_SSE_FIXED(char *plains[VSIZE], char *hash[VSIZE], int lens)
{
